      ...
      >
        ...
        <div className="flex flex-col items-start mb-3">
          ...
          <textarea
            ...
            className=" h-50  p-3  mb-4 w-100 outline-none border-2 border-pink-400 b text-white font-medium"
          />
